    ...
    <div className={`${styles.page} flex-col`}>
      <div className={`${styles.layer1} flex-col`}>
        ...
        <span className={`${styles.infoBox2}`}>
          2022杭州全球人工智能技术创新大赛-算法挑战赛由中国人工智能学会、杭州市人民政府主办，余杭区人民政府、杭州市委组织部（人才办）、杭州市科技局承办，浙江杭州未来科技城
          <br />
          （海创园）管委会具体承办，京东零售协办。大赛将立足国际视野，聚焦前沿科技与应用创新，推进人工智能领域的学术交流、人才培养、技术发展以及跨界应用与融合打造人工智能的
          <br />
          人才交流平台与产业生态圈。
          <br />
          <br />
